...
export default class WhyJoin extends Component {
	render() {
		if (isDesktop)
			return (
				<>
					...
					<Box className="whyjoinclient">
						...
						<Box className="content">
							<Typography className="text">
								Thanks to an automation and digitalization, booking models to create first class
								content, is now possible to smaller brands and start-ups. <br />
								<br />
					...
					<Box className="bepart">
						...
						<Typography className="text">
							By using and supporting ICONICLI, you will automatically contributing to, and be part of a
							higher purpose! We strive to make a better world by supporting 3 of the 17 Global Goals for
							2030, which are connected to the modeling, marketing and media industry.
						</Typography>
					</Box>
			...
			return (
				<Box className="join">
					<Typography className="title">Be a part of something bigger!</Typography>
					<img src={GenderEquality} className="gender" />
					<img src={DecentWork} className="decent" />
					<img src={Reduced} className="reduced" />
					<Box className="line1"></Box>
					<Box className="line2"></Box>
					<Box className="line3"></Box>
					<Box className="text">
						<Typography className="gen">Gender Equality</Typography>
						<Typography className="decent">Decent work and economic growth</Typography>
						<Typography className="reduced">Reduced inequalities</Typography>
					</Box>
					<Typography className="byusing">
						By using and supporting ICONICLI, you will automatically contribute to, and be part of a higher
						purpose! We strive to make a better world by supporting 3 of the 17 Global Goals for 2030, which
						are connected to the modeling, marketing and media industry.
					</Typography>
				</Box>
			);
	}
